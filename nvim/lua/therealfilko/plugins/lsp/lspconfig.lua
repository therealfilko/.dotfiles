    ...
    config = function()
        ...
        vim.diagnostic.config({
            signs = {
                ...
                -- Optional: Nummernspalte einfärben mit bestehenden HL-Gruppen
                numhl = {
                ...
                -- linehl = { [sev.ERROR] = "DiagnosticLineError", ... } -- falls gewünscht
            },
        })
        ...
        vim.lsp.config("dockerfile-language-server", default_opts)
        ...
        vim.lsp.enable("dockerfile-language-serve")
    end,
}
